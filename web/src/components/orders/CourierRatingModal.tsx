        ...
        <form onSubmit={submit}>
          ...
          <div className="flex gap-3 mt-5">
            <button
              type="submit"
              disabled={submitting}
              className="btn-primary flex-1 py-2.5 text-sm min-h-11 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              onClick={onClose}
              disabled={submitting}
              className="btn-secondary py-2.5 px-5 text-sm min-h-11 inline-flex items-center justify-center disabled:opacity-50"
            >
              Skip
            </button>
          </div>
