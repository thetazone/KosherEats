...
export default function SellerOrderDetailPage() {
  ...
  const heading = (
    <div className="mb-6">
      <Link
        href="/seller/orders"
        className="inline-flex items-center gap-1.5 min-h-11 -my-1 text-sm text-dark-400 hover:text-white transition-colors mb-3"
      >
    ...
    <div className="card p-5">
      ...
      {order.external_tracking_url && (
        <a
          ...
          className="flex items-center gap-2 py-2.5 px-3 min-h-11 rounded-xl bg-dark-800 text-brand-400 text-sm font-semibold hover:bg-dark-700 transition-colors"
        >
