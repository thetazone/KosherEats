...
export default function SupportPage() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 text-neutral-200">
      ...
      <p className="text-neutral-400 mb-10">We&apos;re here to help.</p>
        ...
        <section className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
          ...
          <div className="space-y-4 text-neutral-300">
            ...
            <div>
              ...
              <p>Email us at <a href="mailto:partners@koshereats.shop" className="text-orange-400 underline">partners@koshereats.shop</a> and we&apos;ll set up your account and get your menu online.</p>
            </div>
          </div>
        </section>
