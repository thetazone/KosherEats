...
android {
    namespace = "com.greeneats.courier"
    compileSdk = 35
    ...
    signingConfigs {
        ...
        create("release") {
            ...
            storePassword = lp("KEYSTORE_PASSWORD").ifEmpty { "greeneats2026" }
            keyAlias = "upload"
            keyPassword = lp("KEYSTORE_PASSWORD").ifEmpty { "greeneats2026" }
        }
    }
    ...
    defaultConfig {
        ...
        buildConfigField("String", "BASE_URL", "\"https://greeneats-api.fly.dev/api/v1/\"")
