...
internal val DarkKosherEatsColors = KosherEatsColors(
...
internal val LightKosherEatsColors = KosherEatsColors(
...
internal val LocalKosherEatsColors = staticCompositionLocalOf { DarkKosherEatsColors }

val BackgroundBlack: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.backgroundBlack

val BackgroundDark: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.backgroundDark

val SurfaceDark: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.surfaceDark

val SurfaceDarkElevated: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.surfaceDarkElevated

val SurfaceDarkBorder: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.surfaceDarkBorder

val TextWhite: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.textWhite

val TextSecondary: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.textSecondary

val TextTertiary: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.textTertiary

val TextMuted: Color
    @Composable @ReadOnlyComposable
    get() = LocalKosherEatsColors.current.textMuted
